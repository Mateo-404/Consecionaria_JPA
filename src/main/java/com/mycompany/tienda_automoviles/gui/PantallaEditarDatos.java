 ...
 * @author Gary
 */
public class PantallaEditarDatos extends javax.swing.JFrame {
    Automovil automovil;
     ...
     */
    public PantallaEditarDatos(int id) {
        control = new ControladoraLogica();

        this.automovil = control.buscarAutomovil(id);
        initComponents();
        actualizarDatos();
    }
    ...
    private void actualizarDatos() {
        marcatxt.setText(automovil.getMarca());
        modelotxt.setText(automovil.getModelo());
        colortxt.setText(automovil.getColor());
        patentetxt.setText(automovil.getPatente());
    }
    ...
    private void guardarbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_guardarbtnActionPerformed
        if (!marcatxt.getText().isEmpty() && !modelotxt.getText().isEmpty() && !colortxt.getText().isEmpty() && !patentetxt.getText().isEmpty()) {
            automovil.setColor(colortxt.getText());
            automovil.setMarca(marcatxt.getText());
            automovil.setModelo(modelotxt.getText());
            automovil.setPatente(patentetxt.getText());
            
            control.modificarAutomovil(automovil);
            ...
            PantallaVerAutos pantalla = new PantallaVerAutos();
